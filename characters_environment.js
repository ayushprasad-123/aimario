...
var mario, bricks,clouds,mountains,enemyMushrooms,pipes,platforms,coins,nx,ny;
...
function changeGameStatud(character){
  if(nx&&s&& gameConfig.status==="start") {
    world_start.play();
...
function jumping(character){
	if( (ny<133&&character.live) || (touchIsDown&&character.live) ){
